...
import com.uce.edu.repository.EstudianteRepoImpl;
...
public class GestorMatriculaServiceImpl implements IGestorMatriculaService {
	...
	public void matricularVehiculo(String cedulaPropietario, String placaVehiculo) {
		...
		//m.setPropietario(null);//le envio null porque tofavia no vemos las relaciones entre tablas
		...
		//m.setVehiculo(null); //le envio null porque todavia no vemos relaciones entre tablas
